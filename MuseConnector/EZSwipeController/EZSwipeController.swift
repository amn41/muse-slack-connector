...
public class EZSwipeController: UIViewController {
    ...
    public func goNextPageRight()
    {
        clickedRightButton()
    }
    
    public func goPreviousPageLeft()
    {
        clickedLeftButton()
    }
    ...
    private func setupViewControllers() {
        ...
        for index in 0..<stackVC.count {
            ...
            if !navigationBarShouldBeOnBottom {
                stackVC[index].view.frame.origin.y += 0 //Constants.navigationBarHeight
            }
    ...
    private func setupPageViewController() {
        ...
        pageViewController.view.frame = CGRect(x: 0, y: 0  , width: Constants.ScreenWidth, height: Constants.ScreenHeightWithoutStatusBar)  //Constants.StatusBarHeight
    ...
    override public func loadView() {
        ...
        if datasource?.isThereAToken() == true {
            stackStartLocation = datasource?.indexOfStartingPage?() ?? 1
    ...
    @objc private func clickedLeftButton() {
        ...
        print(currentStackVC.description)
